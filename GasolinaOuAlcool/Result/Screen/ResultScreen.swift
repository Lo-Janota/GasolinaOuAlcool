...
class ResultScreen: UIView {
    ...
    public func dalegate(delegate: ResultScreenDelegate?) {
    ...
    func configConstraints(){
        NSLayoutConstraint.activate([
            ...
            sentenceLabel.topAnchor.constraint(equalTo: logoAppImageView.bottomAnchor, constant: 122),
            sentenceLabel.centerXAnchor.constraint(equalTo: centerXAnchor),
            
            resultadoLabel.topAnchor.constraint(equalTo: sentenceLabel.bottomAnchor, constant: 12),
